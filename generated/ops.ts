...
/** MountContentCache ... */
export const MountContentCache = {
  DEFAULT: 0,
  ON: 1,
  OFF: 2,
  UNRECOGNIZED: -1,
...
export const ExecOp: MessageFns<ExecOp> = {
  encode(
    ...
    for (const v of message.mounts) {
      Mount.encode(v!, writer.uint32(18).fork()).join();
    }
    ...
    for (const v of message.secretenv) {
      SecretEnv.encode(v!, writer.uint32(42).fork()).join();
    }
    for (const v of message.cdiDevices) {
      CDIDevice.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ExecOp {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.cdiDevices.push(CDIDevice.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ExecOp {
    return {
      ...
      secretenv: globalThis.Array.isArray(object?.secretenv)
        ...
        : [],
      cdiDevices: globalThis.Array.isArray(object?.cdiDevices)
        ? object.cdiDevices.map((e: any) => CDIDevice.fromJSON(e))
        : [],
    };
  },
...
export const Meta: MessageFns<Meta> = {
  encode(
    ...
    if (message.proxyEnv !== undefined) {
      ProxyEnv.encode(message.proxyEnv, writer.uint32(42).fork()).join();
    }
    ...
    for (const v of message.validExitCodes) {
      writer.int32(v);
    }
    writer.join();
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Meta {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          if (tag === 96) {
            message.validExitCodes.push(reader.int32());
  ...
  fromJSON(object: any): Meta {
    return {
      ...
      removeMountStubsRecursive: isSet(object.removeMountStubsRecursive)
        ...
        : false,
      validExitCodes: globalThis.Array.isArray(object?.validExitCodes)
        ? object.validExitCodes.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
...
export const HostIP: MessageFns<HostIP> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HostIP {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Ulimit: MessageFns<Ulimit> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Ulimit {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecretEnv: MessageFns<SecretEnv> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SecretEnv {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CDIDevice: MessageFns<CDIDevice> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CDIDevice {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<CDIDevice>, I>>(base?: I): CDIDevice {
...
export const Mount: MessageFns<Mount> = {
  encode(
    ...
    if (message.TmpfsOpt !== undefined) {
      TmpfsOpt.encode(message.TmpfsOpt, writer.uint32(154).fork()).join();
    }
    if (message.cacheOpt !== undefined) {
      CacheOpt.encode(message.cacheOpt, writer.uint32(162).fork()).join();
    }
    if (message.secretOpt !== undefined) {
      SecretOpt.encode(message.secretOpt, writer.uint32(170).fork()).join();
    }
  ...
  fromJSON(object: any): Mount {
    return {
      ...
      TmpfsOpt: isSet(object.TmpfsOpt)
        ? TmpfsOpt.fromJSON(object.TmpfsOpt)
        : undefined,
      cacheOpt: isSet(object.cacheOpt)
        ? CacheOpt.fromJSON(object.cacheOpt)
        : undefined,
      secretOpt: isSet(object.secretOpt)
        ? SecretOpt.fromJSON(object.secretOpt)
        : undefined,
...
export const TmpfsOpt: MessageFns<TmpfsOpt> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TmpfsOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CacheOpt: MessageFns<CacheOpt> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CacheOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecretOpt: MessageFns<SecretOpt> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SecretOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SSHOpt: MessageFns<SSHOpt> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SSHOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SourceOp: MessageFns<SourceOp> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SourceOp {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BuildOp: MessageFns<BuildOp> = {
  encode(
    ...
    if (message.def !== undefined) {
      Definition.encode(message.def, writer.uint32(26).fork()).join();
    }
    Object.entries(message.attrs).forEach(([key, value]) => {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BuildOp {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): BuildOp {
    return {
      ...
      inputs: isObject(object.inputs)
        ? Object.entries(object.inputs).reduce<{ [key: string]: BuildInput }>(
            (acc, [key, value]) => {
...
export const BuildOp_InputsEntry: MessageFns<BuildOp_InputsEntry> = {
  encode(
    ...
    if (message.value !== undefined) {
      BuildInput.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const BuildInput: MessageFns<BuildInput> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BuildInput {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OpMetadata: MessageFns<OpMetadata> = {
  encode(
    ...
    if (message.exportCache !== undefined) {
      ExportCache.encode(message.exportCache, writer.uint32(34).fork()).join();
    }
  ...
  fromJSON(object: any): OpMetadata {
    return {
      ignoreCache: isSet(object.ignoreCache)
        ? globalThis.Boolean(object.ignoreCache)
        : false,
      ...
      exportCache: isSet(object.exportCache)
        ? ExportCache.fromJSON(object.exportCache)
        : undefined,
      caps: isObject(object.caps)
        ? Object.entries(object.caps).reduce<{ [key: string]: boolean }>(
            (acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<OpMetadata>, I>>(
    ...
    message.exportCache =
      object.exportCache !== undefined && object.exportCache !== null
        ...
        : undefined;
    message.caps = Object.entries(object.caps ?? {}).reduce<{
      [key: string]: boolean;
    }>((acc, [key, value]) => {
      if (value !== undefined) {
...
export const Source: MessageFns<Source> = {
  encode(
    ...
    for (const v of message.infos) {
      SourceInfo.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Source {
    return {
      locations: isObject(object.locations)
        ? Object.entries(object.locations).reduce<{ [key: string]: Locations }>(
            (acc, [key, value]) => {
      ...
      infos: globalThis.Array.isArray(object?.infos)
        ? object.infos.map((e: any) => SourceInfo.fromJSON(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Source>, I>>(object: I): Source {
    const message = createBaseSource();
    message.locations = Object.entries(object.locations ?? {}).reduce<{
...
export const Source_LocationsEntry: MessageFns<Source_LocationsEntry> = {
  encode(
    ...
    if (message.value !== undefined) {
      Locations.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Range>, I>>(object: I): Range {
    ...
    message.end =
      object.end !== undefined && object.end !== null
        ? Position.fromPartial(object.end)
        : undefined;
    return message;
  },
};
...
export const ExportCache: MessageFns<ExportCache> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportCache {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProgressGroup: MessageFns<ProgressGroup> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProgressGroup {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProxyEnv: MessageFns<ProxyEnv> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProxyEnv {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WorkerConstraints: MessageFns<WorkerConstraints> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WorkerConstraints {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WorkerConstraints {
    return {
      filter: globalThis.Array.isArray(object?.filter)
        ? object.filter.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const Definition: MessageFns<Definition> = {
  ...
  fromJSON(object: any): Definition {
    return {
      def: globalThis.Array.isArray(object?.def)
        ? object.def.map((e: any) => bytesFromBase64(e))
        : [],
      metadata: isObject(object.metadata)
        ? Object.entries(object.metadata).reduce<{ [key: string]: OpMetadata }>(
            (acc, [key, value]) => {
...
export const Definition_MetadataEntry: MessageFns<Definition_MetadataEntry> = {
  encode(
    ...
    if (message.value !== undefined) {
      OpMetadata.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const FileOp: MessageFns<FileOp> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileOp {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): FileOp {
    return {
      actions: globalThis.Array.isArray(object?.actions)
        ? object.actions.map((e: any) => FileAction.fromJSON(e))
        : [],
    };
  },
...
function createBaseFileAction(): FileAction {
  return { input: 0, secondaryInput: 0, output: 0, action: undefined };
}
  ...
  fromJSON(object: any): FileAction {
    return {
      ...
      secondaryInput: isSet(object.secondaryInput)
        ? globalThis.Number(object.secondaryInput)
        : 0,
      output: isSet(object.output) ? globalThis.Number(object.output) : 0,
...
export const FileActionCopy: MessageFns<FileActionCopy> = {
  encode(
    ...
    if (message.owner !== undefined) {
      ChownOpt.encode(message.owner, writer.uint32(26).fork()).join();
    }
    if (message.mode !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileActionCopy {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): FileActionCopy {
    return {
      ...
      followSymlink: isSet(object.followSymlink)
        ? globalThis.Boolean(object.followSymlink)
        : false,
      ...
      createDestPath: isSet(object.createDestPath)
        ? globalThis.Boolean(object.createDestPath)
        : false,
      allowWildcard: isSet(object.allowWildcard)
        ? globalThis.Boolean(object.allowWildcard)
        : false,
      allowEmptyWildcard: isSet(object.allowEmptyWildcard)
        ? globalThis.Boolean(object.allowEmptyWildcard)
        : false,
...
export const FileActionMkFile: MessageFns<FileActionMkFile> = {
  encode(
    ...
    if (message.owner !== undefined) {
      ChownOpt.encode(message.owner, writer.uint32(34).fork()).join();
    }
    if (message.timestamp !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileActionMkFile {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FileActionSymlink: MessageFns<FileActionSymlink> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileActionSymlink {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FileActionMkDir: MessageFns<FileActionMkDir> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileActionMkDir {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FileActionRm: MessageFns<FileActionRm> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileActionRm {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChownOpt: MessageFns<ChownOpt> = {
  encode(
    ...
    if (message.group !== undefined) {
      UserOpt.encode(message.group, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ChownOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<ChownOpt>, I>>(object: I): ChownOpt {
    ...
    message.user =
      object.user !== undefined && object.user !== null
        ? UserOpt.fromPartial(object.user)
        : undefined;
    message.group =
...
export const UserOpt: MessageFns<UserOpt> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NamedUserOpt: MessageFns<NamedUserOpt> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NamedUserOpt {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MergeInput: MessageFns<MergeInput> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MergeInput {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MergeOp: MessageFns<MergeOp> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MergeOp {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): MergeOp {
    return {
      inputs: globalThis.Array.isArray(object?.inputs)
        ? object.inputs.map((e: any) => MergeInput.fromJSON(e))
        : [],
    };
  },
...
export const LowerDiffInput: MessageFns<LowerDiffInput> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LowerDiffInput {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpperDiffInput: MessageFns<UpperDiffInput> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpperDiffInput {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DiffOp: MessageFns<DiffOp> = {
  encode(
    ...
    if (message.upper !== undefined) {
      UpperDiffInput.encode(message.upper, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DiffOp {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DiffOp {
    return {
      lower: isSet(object.lower)
        ? LowerDiffInput.fromJSON(object.lower)
        : undefined,
      upper: isSet(object.upper)
        ? UpperDiffInput.fromJSON(object.upper)
        : undefined,
    };
  },
